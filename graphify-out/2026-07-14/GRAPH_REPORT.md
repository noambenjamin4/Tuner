...
## Corpus Check
- 229 files · ~239,887 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1364 nodes · 3222 edges · 72 communities (63 shown, 9 thin omitted)
...
Cohesion: 0.36
Nodes (8): convertFileToMp3(), convertFileToWav(), decodeAndTrim(), encodeMp3FromChannels(), findLeadingSilenceEnd(), loadMp3Encoder(), MP3_BITRATES, Mp3Encoder
...
Cohesion: 0.30
Nodes (9): FileDrop(), EXPORT_TARGETS, formatDb(), LoudnessPanel(), LoudnessWorkerResult, resampleTo48k(), toneFor(), useFileDrop() (+1 more)
...
Cohesion: 0.15
Nodes (17): AudioEffectResult, Status, AudioFormatPicker(), AudioOutputFormat, MP3_BITRATES, AudioJoinerTool(), nextId(), QueuedFile (+9 more)
