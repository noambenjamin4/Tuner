...
const ja: Record<keyof typeof en, string> = {
  ...
  "analysis.stageDecoding": "{name} をデコード中...",
  "analysis.stageResampling": "{name} を準備中...",
  ...
  "ytDownloader.serverWakingTitle": "サーバー起動中",
  "ytDownloader.serverWaking": "ダウンロードサーバーを起動しています。1 分ほどかかります。しばらくしてからもう一度お試しください。",
  ...
  "remix.recordingTitle": "録音中",
  "remix.recordingMessage": "コントロールを動かしてください。すべての変化がタイミングごと記録されます。",
  "remix.recordingReadout": "録音中 · {time} · {count} 操作",
  "remix.lockPitchOffTitle": "ピッチ固定をオフにしました",
  "remix.lockPitchOffMessage": "ピッチ固定は録音できないため、速度とピッチが連動します。最初から録音します。",
  "remix.renderingMovesMessage": "録音した操作をエクスポートに反映しています。",
  ...
  "stage.decoding": "ファイルをデコード中…",
  "stage.resampling": "48 kHzにリサンプリング中…",
  "stage.measuringInput": "ラウドネス測定中…",
  "stage.rendering": "マスターをレンダリング中…",
  "stage.normalizing": "ラウドネスを正規化中…",
  "stage.measuringOutput": "マスターを測定中…",
  ...
  "audiomasteringtool.before": "処理前",
  "audiomasteringtool.after": "処理後",
  "audiomasteringtool.beforeSub": "オリジナル",
  "audiomasteringtool.afterSub": "マスタリング済み",
  ...
  "audiomasteringtool.genreLabel": "ジャンルプリセット",
  "audiomasteringtool.genreCustom": "カスタム",
  "audiomasteringtool.genreEdm": "EDM",
  "audiomasteringtool.genreHiphop": "ヒップホップ",
  "audiomasteringtool.genrePop": "ポップ",
  "audiomasteringtool.genreRock": "ロック",
  "audiomasteringtool.genreAcoustic": "アコースティック",
  "audiomasteringtool.genreLofi": "Lo-Fi",
  "audiomasteringtool.genreSetsTone": "ジャンルプリセットが音色を決めます。手動で調整するにはカスタムを選択してください。",
  ...
  "audiomasteringtool.faq1A":
    "共有する前に、曲に最終的な仕上げを与えます。低域のランブルを取り除き、EQで音色を整え、軽いコンプレッションでミックスをまとめ、その後全体を設定したラウドネスまで持ち上げ、SpotifyやYouTubeで再エンコードされてもクリップしないよう、ピークを天井のすぐ下に抑えます。結果として音はより豊かになり、他の曲と並べても一定の音量で再生されます。",
  "audiomasteringtool.faq2Q": "ジャンルプリセットは何をしますか？",
  "audiomasteringtool.faq2A":
    "それぞれそのスタイル用に調整された出発点です。EDMとHip-Hopは力強い低域で大きめに、PopとRockはより明るくラジオ向けに、アコースティックとLo-Fiはより柔らかく自然に仕上がります。近いものを選び、そこからラウドネス・音色・広がりを微調整するか、カスタムを選んですべて自分で設定してください。",
  "audiomasteringtool.faq3Q": "マスターが本当に良くなったかどうやって分かりますか？",
  "audiomasteringtool.faq3A":
    "処理前と処理後を切り替えて聴いてください。まず「音量をそろえる」をオンにして両方を同じ音量で再生します。そうしないと大きいほうが常に良く聞こえ、音色を判断できないからです。パネルには数値も表示されます。入力と出力のラウドネス（LUFS）、true peak、そして残っているダイナミックレンジです。",
  "audiomasteringtool.faq4Q": "「リファレンス曲に合わせる」は何をしますか？",
  "audiomasteringtool.faq4A":
    "自分の曲をこう響かせたい、という曲をドロップしてください。TuneBadがそのトラックの音色バランスとラウドネスを読み取り、あなたのマスターをそこへ近づけます。これにより、あなたのミックスはすでに信頼している作品と同じ土俵に収まります。有料サービスが料金を取るリファレンスマッチングの、ブラウザ内で使える無料版です。",
  "audiomasteringtool.faq5Q": "音声ファイルはどこかにアップロードされますか？",
  "audiomasteringtool.faq5A":
    "いいえ。デコード、マスタリング、エンコードはすべてWeb Audio APIを使ってブラウザ内で行われます。あなたのファイルもリファレンス曲も端末から外に出ることはありません。",
  "audiomasteringtool.faq6Q": "プロのマスタリングエンジニアと同じくらい良いですか？",
