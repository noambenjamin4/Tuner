...
const zh: Record<keyof typeof en, string> = {
  ...
  "analysis.stageDecoding": "正在解码 {name}...",
  "analysis.stageResampling": "正在准备 {name}...",
  ...
  "ytDownloader.serverWakingTitle": "服务启动中",
  "ytDownloader.serverWaking": "下载服务正在启动，大约需要一分钟。请稍后再试。",
  ...
  "remix.recordingTitle": "录制中",
  "remix.recordingMessage": "调整控件——每次改动都会连同时间点一起记录。",
  "remix.recordingReadout": "录制中 · {time} · {count} 次操作",
  "remix.lockPitchOffTitle": "已关闭音高锁定",
  "remix.lockPitchOffMessage": "音高锁定无法录制，因此速度与音高将一起变化。将从头开始录制。",
  "remix.renderingMovesMessage": "正在把录制的操作写入导出文件。",
  ...
  "stage.decoding": "正在解码文件…",
  "stage.resampling": "正在重采样至48 kHz…",
  "stage.measuringInput": "正在测量响度…",
  "stage.rendering": "正在渲染母带…",
  "stage.normalizing": "正在归一化响度…",
  "stage.measuringOutput": "正在测量母带…",
  ...
  "audiomasteringtool.before": "处理前",
  "audiomasteringtool.after": "处理后",
  "audiomasteringtool.beforeSub": "原始",
  "audiomasteringtool.afterSub": "母带处理",
  ...
  "audiomasteringtool.genreLabel": "曲风预设",
  "audiomasteringtool.genreCustom": "自定义",
  "audiomasteringtool.genreEdm": "EDM",
  "audiomasteringtool.genreHiphop": "嘻哈",
  "audiomasteringtool.genrePop": "流行",
  "audiomasteringtool.genreRock": "摇滚",
  "audiomasteringtool.genreAcoustic": "原声",
  "audiomasteringtool.genreLofi": "Lo-Fi",
  "audiomasteringtool.genreSetsTone": "曲风预设决定音色；选择自定义可手动控制。",
